...
class CreditCardForm extends StatefulWidget {
  ...
  /// Error message string when invalid credit card amount is entered.
  final String amountValidationMessage;
                  ...
                  validator: widget.cardHolderValidator ??
                      (String? value) {
                        if (value!.isEmpty || double.parse(value) == 0) {
                          return widget.amountValidationMessage;
                        }
                        return null;
                      },
                ),
              ...
              children: <Widget>[
                Visibility(
                  ...
                  child: Expanded(
                    child: Container(
                      padding: const EdgeInsets.symmetric(vertical: 8.0),
                      margin: const EdgeInsets.only(left: 16, top: 8, right: 3),
                      child: TextFormField(
                ...
                Expanded(
                  child: Visibility(
                    ...
                    child: Container(
                      padding: const EdgeInsets.symmetric(vertical: 8.0),
                      margin: const EdgeInsets.only(left: 3, top: 8, right: 16),
                      child: TextFormField(
