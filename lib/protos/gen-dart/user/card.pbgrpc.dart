...
class CardServiceClient extends $grpc.Client {
  ...
  static final _$cardBind = $grpc.ClientMethod<$1.CardBindRequest, $1.CardBindResponse>(
  ...
  $grpc.ResponseFuture<$1.CardBindResponse> cardBind($1.CardBindRequest request, {$grpc.CallOptions? options}) {
...
abstract class CardServiceBase extends $grpc.Service {
  ...
  CardServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.CardBindRequest, $1.CardBindResponse>(
        'CardBind',
        cardBind_Pre,
        false,
        false,
  ...
  $async.Future<$1.CardBindResponse> cardBind_Pre($grpc.ServiceCall call, $async.Future<$1.CardBindRequest> request) async {
