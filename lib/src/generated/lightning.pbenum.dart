...
class AddressType extends $pb.ProtobufEnum {
  static const AddressType WITNESS_PUBKEY_HASH_Disabled = AddressType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'WITNESS_PUBKEY_HASH_Disabled');
  static const AddressType NESTED_PUBKEY_HASH_Disabled = AddressType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NESTED_PUBKEY_HASH_Disabled');
  static const AddressType PUBKEY = AddressType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PUBKEY');
  static const AddressType UNUSED_WITNESS_PUBKEY_HASH = AddressType._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNUSED_WITNESS_PUBKEY_HASH');
  static const AddressType UNUSED_NESTED_PUBKEY_HASH = AddressType._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNUSED_NESTED_PUBKEY_HASH');
  static const AddressType NFT_WITNESS_PUBKEY_HASH = AddressType._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NFT_WITNESS_PUBKEY_HASH');
  static const AddressType TAPROOT_PUBKEY = AddressType._(6, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TAPROOT_PUBKEY');

  static const $core.List<AddressType> values = <AddressType> [
    WITNESS_PUBKEY_HASH_Disabled,
    NESTED_PUBKEY_HASH_Disabled,
    PUBKEY,
    UNUSED_WITNESS_PUBKEY_HASH,
    UNUSED_NESTED_PUBKEY_HASH,
    NFT_WITNESS_PUBKEY_HASH,
    TAPROOT_PUBKEY,
  ];
