...
class SendPaymentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SendPaymentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'routerrpc'), createEmptyInstance: create)
    ...
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetAmt')
    ...
    ..pc<$0.FeatureBit>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destFeatures', $pb.PbFieldType.KE, valueOf: $0.FeatureBit.valueOf, enumValues: $0.FeatureBit.values, defaultEnumValue: $0.FeatureBit.DATALOSS_PROTECT_REQ)
    ...
    ..p<$fixnum.Int64>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outgoingChanIds', $pb.PbFieldType.KU6)
    ...
    ..aOB(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amp')
    ..a<$core.int>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetId', $pb.PbFieldType.OU3)
  ...
  @$pb.TagNumber(2)
  $fixnum.Int64 get assetAmt => $_getI64(1);
  @$pb.TagNumber(2)
  set assetAmt($fixnum.Int64 v) { $_setInt64(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasAssetAmt() => $_has(1);
  @$pb.TagNumber(2)
  void clearAssetAmt() => clearField(2);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  $fixnum.Int64 get outgoingChanId => $_getI64(6);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  set outgoingChanId($fixnum.Int64 v) { $_setInt64(6, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  $core.bool hasOutgoingChanId() => $_has(6);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  void clearOutgoingChanId() => clearField(8);

  @$pb.TagNumber(9)
  $core.int get cltvLimit => $_getIZ(7);
  @$pb.TagNumber(9)
  set cltvLimit($core.int v) { $_setSignedInt32(7, v); }
  @$pb.TagNumber(9)
  $core.bool hasCltvLimit() => $_has(7);
  @$pb.TagNumber(9)
  void clearCltvLimit() => clearField(9);

  @$pb.TagNumber(10)
  $core.List<$0.RouteHint> get routeHints => $_getList(8);
  ...
  @$pb.TagNumber(13)
  $fixnum.Int64 get feeLimitMsat => $_getI64(11);
  @$pb.TagNumber(13)
  set feeLimitMsat($fixnum.Int64 v) { $_setInt64(11, v); }
  @$pb.TagNumber(13)
  $core.bool hasFeeLimitMsat() => $_has(11);
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(16)
  $core.List<$0.FeatureBit> get destFeatures => $_getList(14);

  @$pb.TagNumber(17)
  $core.int get maxParts => $_getIZ(15);
  @$pb.TagNumber(17)
  set maxParts($core.int v) { $_setUnsignedInt32(15, v); }
  @$pb.TagNumber(17)
  $core.bool hasMaxParts() => $_has(15);
  @$pb.TagNumber(17)
  void clearMaxParts() => clearField(17);

  @$pb.TagNumber(18)
  $core.bool get noInflightUpdates => $_getBF(16);
  @$pb.TagNumber(18)
  set noInflightUpdates($core.bool v) { $_setBool(16, v); }
  @$pb.TagNumber(18)
  $core.bool hasNoInflightUpdates() => $_has(16);
  @$pb.TagNumber(18)
  void clearNoInflightUpdates() => clearField(18);

  @$pb.TagNumber(19)
  $core.List<$fixnum.Int64> get outgoingChanIds => $_getList(17);

  @$pb.TagNumber(20)
  $core.List<$core.int> get paymentAddr => $_getN(18);
  @$pb.TagNumber(20)
  set paymentAddr($core.List<$core.int> v) { $_setBytes(18, v); }
  @$pb.TagNumber(20)
  $core.bool hasPaymentAddr() => $_has(18);
  @$pb.TagNumber(20)
  void clearPaymentAddr() => clearField(20);

  @$pb.TagNumber(21)
  $fixnum.Int64 get maxShardSizeMsat => $_getI64(19);
  @$pb.TagNumber(21)
  set maxShardSizeMsat($fixnum.Int64 v) { $_setInt64(19, v); }
  @$pb.TagNumber(21)
  $core.bool hasMaxShardSizeMsat() => $_has(19);
  @$pb.TagNumber(21)
  void clearMaxShardSizeMsat() => clearField(21);

  @$pb.TagNumber(22)
  $core.bool get amp => $_getBF(20);
  @$pb.TagNumber(22)
  set amp($core.bool v) { $_setBool(20, v); }
  @$pb.TagNumber(22)
  $core.bool hasAmp() => $_has(20);
  @$pb.TagNumber(22)
  void clearAmp() => clearField(22);

  @$pb.TagNumber(23)
  $core.int get assetId => $_getIZ(21);
  @$pb.TagNumber(23)
  set assetId($core.int v) { $_setUnsignedInt32(21, v); }
  @$pb.TagNumber(23)
  $core.bool hasAssetId() => $_has(21);
  @$pb.TagNumber(23)
...
class RouteFeeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RouteFeeRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'routerrpc'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dest', $pb.PbFieldType.OY)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amtMsat')
    ..a<$core.int>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetId', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $fixnum.Int64 get amtMsat => $_getI64(1);
  @$pb.TagNumber(2)
  set amtMsat($fixnum.Int64 v) { $_setInt64(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasAmtMsat() => $_has(1);
  @$pb.TagNumber(2)
  void clearAmtMsat() => clearField(2);
...
class XImportMissionControlRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'XImportMissionControlRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'routerrpc'), createEmptyInstance: create)
    ..pc<PairHistory>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pairs', $pb.PbFieldType.PM, subBuilder: PairHistory.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  XImportMissionControlRequest copyWith(void Function(XImportMissionControlRequest) updates) => super.copyWith((message) => updates(message as XImportMissionControlRequest)) as XImportMissionControlRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class XImportMissionControlResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'XImportMissionControlResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'routerrpc'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  XImportMissionControlResponse copyWith(void Function(XImportMissionControlResponse) updates) => super.copyWith((message) => updates(message as XImportMissionControlResponse)) as XImportMissionControlResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PairData extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  $fixnum.Int64 get failAmtMsat => $_getI64(1);
  @$pb.TagNumber(4)
  set failAmtMsat($fixnum.Int64 v) { $_setInt64(1, v); }
  @$pb.TagNumber(4)
  $core.bool hasFailAmtMsat() => $_has(1);
  @$pb.TagNumber(4)
  void clearFailAmtMsat() => clearField(4);

  @$pb.TagNumber(5)
  $fixnum.Int64 get successTime => $_getI64(2);
  @$pb.TagNumber(5)
  set successTime($fixnum.Int64 v) { $_setInt64(2, v); }
  @$pb.TagNumber(5)
  $core.bool hasSuccessTime() => $_has(2);
  @$pb.TagNumber(5)
  void clearSuccessTime() => clearField(5);

  @$pb.TagNumber(7)
  $fixnum.Int64 get successAmtMsat => $_getI64(3);
  @$pb.TagNumber(7)
  set successAmtMsat($fixnum.Int64 v) { $_setInt64(3, v); }
  @$pb.TagNumber(7)
  $core.bool hasSuccessAmtMsat() => $_has(3);
  @$pb.TagNumber(7)
  void clearSuccessAmtMsat() => clearField(7);
}

class GetMissionControlConfigRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetMissionControlConfigRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'routerrpc'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetMissionControlConfigRequest copyWith(void Function(GetMissionControlConfigRequest) updates) => super.copyWith((message) => updates(message as GetMissionControlConfigRequest)) as GetMissionControlConfigRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetMissionControlConfigResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetMissionControlConfigResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'routerrpc'), createEmptyInstance: create)
    ..aOM<MissionControlConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'config', subBuilder: MissionControlConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetMissionControlConfigResponse copyWith(void Function(GetMissionControlConfigResponse) updates) => super.copyWith((message) => updates(message as GetMissionControlConfigResponse)) as GetMissionControlConfigResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set config(MissionControlConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class SetMissionControlConfigRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SetMissionControlConfigRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'routerrpc'), createEmptyInstance: create)
    ..aOM<MissionControlConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'config', subBuilder: MissionControlConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetMissionControlConfigRequest copyWith(void Function(SetMissionControlConfigRequest) updates) => super.copyWith((message) => updates(message as SetMissionControlConfigRequest)) as SetMissionControlConfigRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SetMissionControlConfigResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SetMissionControlConfigResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'routerrpc'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetMissionControlConfigResponse copyWith(void Function(SetMissionControlConfigResponse) updates) => super.copyWith((message) => updates(message as SetMissionControlConfigResponse)) as SetMissionControlConfigResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MissionControlConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MissionControlConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'routerrpc'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'halfLifeSeconds', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hopProbability', $pb.PbFieldType.OF)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'weight', $pb.PbFieldType.OF)
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maximumPaymentResults', $pb.PbFieldType.OU3)
    ..a<$fixnum.Int64>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minimumFailureRelaxInterval', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MissionControlConfig copyWith(void Function(MissionControlConfig) updates) => super.copyWith((message) => updates(message as MissionControlConfig)) as MissionControlConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateChanStatusRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateChanStatusRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'routerrpc'), createEmptyInstance: create)
    ..aOM<$0.ChannelPoint>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'chanPoint', subBuilder: $0.ChannelPoint.create)
    ..e<ChanStatusAction>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'action', $pb.PbFieldType.OE, defaultOrMaker: ChanStatusAction.ENABLE, valueOf: ChanStatusAction.valueOf, enumValues: ChanStatusAction.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateChanStatusRequest copyWith(void Function(UpdateChanStatusRequest) updates) => super.copyWith((message) => updates(message as UpdateChanStatusRequest)) as UpdateChanStatusRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set chanPoint($0.ChannelPoint v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set action(ChanStatusAction v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAction() => $_has(1);
  @$pb.TagNumber(2)
  void clearAction() => clearField(2);
...
class UpdateChanStatusResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateChanStatusResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'routerrpc'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateChanStatusResponse copyWith(void Function(UpdateChanStatusResponse) updates) => super.copyWith((message) => updates(message as UpdateChanStatusResponse)) as UpdateChanStatusResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
