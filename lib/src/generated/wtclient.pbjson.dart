...
const TowerSession$json = const {
  ...
  '2': const [
    ...
    const {'1': 'sweep_sat_per_vbyte', '3': 5, '4': 1, '5': 13, '10': 'sweepSatPerVbyte'},
  ],
};

/// Descriptor for `TowerSession`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List towerSessionDescriptor = $convert.base64Decode('');
...
const PolicyResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'sweep_sat_per_vbyte', '3': 3, '4': 1, '5': 13, '10': 'sweepSatPerVbyte'},
  ],
};

/// Descriptor for `PolicyResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List policyResponseDescriptor = $convert.base64Decode('Cg5Qb2xpY3lSZXNwb25zZRIfCgttYXhfdXBkYXRlcxgBIAEoDVIKbWF4VXBkYXRlcxIvChJzd2VlcF9zYXRfcGVyX2J5dGUYAiABKA1CAhgBUg9zd2VlcFNhdFBlckJ5dGUSLQoTc3dlZXBfc2F0X3Blcl92Ynl0ZRgDIAEoDVIQc3dlZXBTYXRQZXJWYnl0ZQ==');
