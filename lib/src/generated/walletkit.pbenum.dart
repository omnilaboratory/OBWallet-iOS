...
class AddressType extends $pb.ProtobufEnum {
  static const AddressType UNKNOWN = AddressType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');
  static const AddressType WITNESS_PUBKEY_HASH = AddressType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'WITNESS_PUBKEY_HASH');
  static const AddressType NESTED_WITNESS_PUBKEY_HASH = AddressType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NESTED_WITNESS_PUBKEY_HASH');
  static const AddressType PubKeyHash = AddressType._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PubKeyHash');
  static const AddressType HYBRID_NESTED_WITNESS_PUBKEY_HASH = AddressType._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'HYBRID_NESTED_WITNESS_PUBKEY_HASH');
...
class WitnessType extends $pb.ProtobufEnum {
  ...
  static const WitnessType PUBKEY_HASH = WitnessType._(14, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PUBKEY_HASH');
