...
final $typed_data.Uint8List chanStatusActionDescriptor = $convert.base64Decode('ChBDaGFuU3RhdHVzQWN0aW9uEgoKBkVOQUJMRRAAEgsKB0RJU0FCTEUQARIICgRBVVRPEAI=');
...
const SendPaymentRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'asset_id', '3': 23, '4': 1, '5': 13, '10': 'assetId'},
    const {'1': 'asset_amt', '3': 2, '4': 1, '5': 3, '10': 'assetAmt'},
...
final $typed_data.Uint8List sendPaymentRequestDescriptor = $convert.base64Decode('');
...
const RouteFeeRequest$json = const {
  ...
  '2': const [
    const {'1': 'dest', '3': 1, '4': 1, '5': 12, '10': 'dest'},
    const {'1': 'amt_msat', '3': 2, '4': 1, '5': 3, '10': 'amtMsat'},
    const {'1': 'asset_id', '3': 23, '4': 1, '5': 13, '10': 'assetId'},
  ],
};

/// Descriptor for `RouteFeeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List routeFeeRequestDescriptor = $convert.base64Decode('Cg9Sb3V0ZUZlZVJlcXVlc3QSEgoEZGVzdBgBIAEoDFIEZGVzdBIZCghhbXRfbXNhdBgCIAEoA1IHYW10TXNhdBIZCghhc3NldF9pZBgXIAEoDVIHYXNzZXRJZA==');
...
const XImportMissionControlRequest$json = const {
  ...
  '2': const [
    const {'1': 'pairs', '3': 1, '4': 3, '5': 11, '6': '.routerrpc.PairHistory', '10': 'pairs'},
...
final $typed_data.Uint8List xImportMissionControlRequestDescriptor = $convert.base64Decode('ChxYSW1wb3J0TWlzc2lvbkNvbnRyb2xSZXF1ZXN0EiwKBXBhaXJzGAEgAygLMhYucm91dGVycnBjLlBhaXJIaXN0b3J5UgVwYWlycxIUCgVmb3JjZRgCIAEoCFIFZm9yY2U=');
...
final $typed_data.Uint8List xImportMissionControlResponseDescriptor = $convert.base64Decode('Ch1YSW1wb3J0TWlzc2lvbkNvbnRyb2xSZXNwb25zZQ==');
...
final $typed_data.Uint8List pairDataDescriptor = $convert.base64Decode('CghQYWlyRGF0YRIbCglmYWlsX3RpbWUYASABKANSCGZhaWxUaW1lEiIKDWZhaWxfYW10X21zYXQYBCABKANSC2ZhaWxBbXRNc2F0EiEKDHN1Y2Nlc3NfdGltZRgFIAEoA1ILc3VjY2Vzc1RpbWUSKAoQc3VjY2Vzc19hbXRfbXNhdBgHIAEoA1IOc3VjY2Vzc0FtdE1zYXRKBAgDEAQ=');
...
final $typed_data.Uint8List getMissionControlConfigRequestDescriptor = $convert.base64Decode('Ch5HZXRNaXNzaW9uQ29udHJvbENvbmZpZ1JlcXVlc3Q=');
...
const GetMissionControlConfigResponse$json = const {
  ...
  '2': const [
    const {'1': 'config', '3': 1, '4': 1, '5': 11, '6': '.routerrpc.MissionControlConfig', '10': 'config'},
  ],
};

/// Descriptor for `GetMissionControlConfigResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMissionControlConfigResponseDescriptor = $convert.base64Decode('Ch9HZXRNaXNzaW9uQ29udHJvbENvbmZpZ1Jlc3BvbnNlEjcKBmNvbmZpZxgBIAEoCzIfLnJvdXRlcnJwYy5NaXNzaW9uQ29udHJvbENvbmZpZ1IGY29uZmln');
...
final $typed_data.Uint8List setMissionControlConfigRequestDescriptor = $convert.base64Decode('Ch5TZXRNaXNzaW9uQ29udHJvbENvbmZpZ1JlcXVlc3QSNwoGY29uZmlnGAEgASgLMh8ucm91dGVycnBjLk1pc3Npb25Db250cm9sQ29uZmlnUgZjb25maWc=');
...
final $typed_data.Uint8List setMissionControlConfigResponseDescriptor = $convert.base64Decode('Ch9TZXRNaXNzaW9uQ29udHJvbENvbmZpZ1Jlc3BvbnNl');
@$core.Deprecated('Use missionControlConfigDescriptor instead')
const MissionControlConfig$json = const {
  '1': 'MissionControlConfig',
  '2': const [
    const {'1': 'half_life_seconds', '3': 1, '4': 1, '5': 4, '10': 'halfLifeSeconds'},
    const {'1': 'hop_probability', '3': 2, '4': 1, '5': 2, '10': 'hopProbability'},
    const {'1': 'weight', '3': 3, '4': 1, '5': 2, '10': 'weight'},
    const {'1': 'maximum_payment_results', '3': 4, '4': 1, '5': 13, '10': 'maximumPaymentResults'},
    const {'1': 'minimum_failure_relax_interval', '3': 5, '4': 1, '5': 4, '10': 'minimumFailureRelaxInterval'},
  ],
};

/// Descriptor for `MissionControlConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List missionControlConfigDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List buildRouteRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List settleEventDescriptor = $convert.base64Decode('CgtTZXR0bGVFdmVudBIaCghwcmVpbWFnZRgBIAEoDFIIcHJlaW1hZ2U=');
...
const UpdateChanStatusRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'action', '3': 2, '4': 1, '5': 14, '6': '.routerrpc.ChanStatusAction', '10': 'action'},
  ],
};

/// Descriptor for `UpdateChanStatusRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateChanStatusRequestDescriptor = $convert.base64Decode('ChdVcGRhdGVDaGFuU3RhdHVzUmVxdWVzdBIyCgpjaGFuX3BvaW50GAEgASgLMhMubG5ycGMuQ2hhbm5lbFBvaW50UgljaGFuUG9pbnQSMwoGYWN0aW9uGAIgASgOMhsucm91dGVycnBjLkNoYW5TdGF0dXNBY3Rpb25SBmFjdGlvbg==');
...
final $typed_data.Uint8List updateChanStatusResponseDescriptor = $convert.base64Decode('ChhVcGRhdGVDaGFuU3RhdHVzUmVzcG9uc2U=');
