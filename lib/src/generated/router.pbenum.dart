...
class ChanStatusAction extends $pb.ProtobufEnum {
  static const ChanStatusAction ENABLE = ChanStatusAction._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ENABLE');
  static const ChanStatusAction DISABLE = ChanStatusAction._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DISABLE');
  static const ChanStatusAction AUTO = ChanStatusAction._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'AUTO');
