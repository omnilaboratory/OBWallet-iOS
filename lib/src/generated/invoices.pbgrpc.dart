...
class InvoicesClient extends $grpc.Client {
  ...
  static final _$lookupInvoiceV2 =
      $grpc.ClientMethod<$1.LookupInvoiceMsg, $0.Invoice>(
          '/invoicesrpc.Invoices/LookupInvoiceV2',
          ($1.LookupInvoiceMsg value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $0.Invoice.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.Invoice> lookupInvoiceV2($1.LookupInvoiceMsg request,
      {$grpc.CallOptions? options}) {
...
abstract class InvoicesServiceBase extends $grpc.Service {
  ...
  InvoicesServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.LookupInvoiceMsg, $0.Invoice>(
        'LookupInvoiceV2',
        lookupInvoiceV2_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.LookupInvoiceMsg.fromBuffer(value),
        ($0.Invoice value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$0.Invoice> lookupInvoiceV2_Pre($grpc.ServiceCall call,
      $async.Future<$1.LookupInvoiceMsg> request) async {
  ...
  $async.Future<$0.Invoice> lookupInvoiceV2(
      $grpc.ServiceCall call, $1.LookupInvoiceMsg request);
}
