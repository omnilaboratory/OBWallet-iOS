...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(createFee) => "*** 申請虛擬卡片需要支付 ${createFee} 美元的費用。";

  static String m5(createFee) => "*** 申請實體卡片需要支付 ${createFee} 美元的費用。";

  static String m6(step) => "第 ${step} 步";

  static String m7(amount) => "等待輸入(金額必須大於等於\$${amount})";

  static String m8(amount) => "餘額: ${amount} NFT";

  static String m9(totalReward, totalUser) =>
      "獎勵總數: ${totalReward} 來自 ${totalUser} 用戶";

  static String m10(email) => "驗證碼會寄到你的信箱\n${email}";

  static String m11(fee) => "申請實體卡有${fee}元的費用，請先充值。";

  static String m12(fee) => "需支付${fee}美元，餘額不足，請儲值。";

  static String m13(fee) => "申請實體卡需支付${fee}美元，請確認。";

  static String m14(fee) => "費用 ${fee}";

  static String m15(cost) => "網路成本 ${cost}";

  static String m16(nftTotalCount, nftTotalValue) =>
      "您已選擇 ${nftTotalCount} 個 NFT,總值 ${nftTotalValue} 美元";

  static String m17(amount, fee) => "將獲得 ${amount},手續費為 ${fee}";

  static String m18(createCardFee) =>
      "申請虛擬卡需要支付 ${createCardFee} 美元的費用。\n美元不足,請點擊首頁的存款購買 USDT,然後兌換為美元。";

  static String m19(tokenName) => "${tokenName} 活動";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "card_newPsw": MessageLookupByLibrary.simpleMessage("卡密碼"),
