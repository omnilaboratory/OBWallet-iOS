...
class TestNftContract extends _i1.GeneratedContract {
  ...
  /// set by the contract.
  Future<String> mintSpecial(
    List<BigInt> specialIds,
    List<BigInt> amounts, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[4];
    assert(checkSignature(function, '534b6b06'));
    final params = [
      specialIds,
      amounts,
    ];
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> startingIndexBlock({_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[11];
    assert(checkSignature(function, 'e36d6498'));
    final params = [];
    final response = await read(
      function,
      params,
